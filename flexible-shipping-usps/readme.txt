...
= 3.5.0 - 2026-07-13 =
* Added an AI chat assistant to USPS settings

= 3.4.0 - 2026-06-15 =
* Updated USPS shipping service library to add default REST API service settings
...
= 3.3.0 - 2026-03-23 =
* Added support for WordPress 7.0
* Fixed missing fees in USPS rates pricing
