...
class PackedBox implements \JsonSerializable
{
     ...
     * Items in the box.
     */
    protected \FlexibleShippingUspsVendor\DVDoug\BoxPacker\PackedItemList $items;
    /**
     ...
     * Get box used.
     */
    public function getBox() : \FlexibleShippingUspsVendor\DVDoug\BoxPacker\Box
    {
        return $this->box;
    }
    /**
     * Get items packed.
     */
    public function getItems() : \FlexibleShippingUspsVendor\DVDoug\BoxPacker\PackedItemList
    {
        return $this->items;
    }
    /**
    ...
    public function __construct(\FlexibleShippingUspsVendor\DVDoug\BoxPacker\Box $box, \FlexibleShippingUspsVendor\DVDoug\BoxPacker\PackedItemList $packedItemList)
    {
        $this->box = $box;
