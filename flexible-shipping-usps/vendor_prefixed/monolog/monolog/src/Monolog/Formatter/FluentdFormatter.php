 ...
 */
class FluentdFormatter implements \FlexibleShippingUspsVendor\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \FlexibleShippingUspsVendor\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
