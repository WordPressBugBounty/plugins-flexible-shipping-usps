 ...
 */
class MongoDBFormatter implements \FlexibleShippingUspsVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \FlexibleShippingUspsVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \FlexibleShippingUspsVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
