 ...
 */
abstract class AbstractHandler extends \FlexibleShippingUspsVendor\Monolog\Handler\Handler implements \FlexibleShippingUspsVendor\Monolog\ResettableInterface
{
    /**
     * @var int
     * @phpstan-var Level
     */
    protected $level = \FlexibleShippingUspsVendor\Monolog\Logger::DEBUG;
    /** @var bool */
