 ...
 */
namespace FlexibleShippingUspsVendor\Monolog\Handler\FingersCrossed;
 ...
 */
class ChannelLevelActivationStrategy implements \FlexibleShippingUspsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \FlexibleShippingUspsVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
