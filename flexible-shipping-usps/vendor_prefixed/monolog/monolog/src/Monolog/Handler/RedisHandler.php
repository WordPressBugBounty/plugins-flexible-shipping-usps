 ...
 */
class RedisHandler extends \FlexibleShippingUspsVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FlexibleShippingUspsVendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \FlexibleShippingUspsVendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    {
        return new \FlexibleShippingUspsVendor\Monolog\Formatter\LineFormatter();
    }
}
