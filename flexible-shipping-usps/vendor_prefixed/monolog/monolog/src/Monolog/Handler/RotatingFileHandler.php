 ...
 */
class RotatingFileHandler extends \FlexibleShippingUspsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \FlexibleShippingUspsVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \FlexibleShippingUspsVendor\Monolog\Utils::canonicalizePath($filename);
