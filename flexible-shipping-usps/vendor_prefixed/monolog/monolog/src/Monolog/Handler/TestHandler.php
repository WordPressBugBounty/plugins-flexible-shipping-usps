 ...
 */
class TestHandler extends \FlexibleShippingUspsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\FlexibleShippingUspsVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
