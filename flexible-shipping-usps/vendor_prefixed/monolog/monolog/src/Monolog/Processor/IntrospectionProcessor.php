 ...
 */
class IntrospectionProcessor implements \FlexibleShippingUspsVendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \FlexibleShippingUspsVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \FlexibleShippingUspsVendor\Monolog\Logger::toMonologLevel($level);
