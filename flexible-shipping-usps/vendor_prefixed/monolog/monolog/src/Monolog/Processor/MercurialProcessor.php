 ...
 */
class MercurialProcessor implements \FlexibleShippingUspsVendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \FlexibleShippingUspsVendor\Monolog\Logger::DEBUG)
    {
