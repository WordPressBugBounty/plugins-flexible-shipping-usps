...
namespace FlexibleShippingUspsVendor\Octolize\Usps\DomesticPrices;
...
class DomesticPricesClientOptions implements ApiClientOptions, LoggerAwareInterface
{
    ...
    {
        return DomesticPricesClient::class;
    }
