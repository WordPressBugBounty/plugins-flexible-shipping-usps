...
use FlexibleShippingUspsVendor\Octolize\Usps\DomesticPrices\Request\TotalRatesSearch;
...
class DomesticPricesApi implements LoggerAwareInterface
{
    ...
    public function get_rates(DomesticPricesSearchParameters $search_parameters): array
    {
