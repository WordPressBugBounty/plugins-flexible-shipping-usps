...
namespace FlexibleShippingUspsVendor\Octolize\Usps\InternationalPrices;

use FlexibleShippingUspsVendor\Octolize\Usps\JsonContentSerializer;
...
class InternationalPricesClientOptions implements ApiClientOptions, LoggerAwareInterface
{
    ...
    {
        return InternationalPricesClient::class;
    }
