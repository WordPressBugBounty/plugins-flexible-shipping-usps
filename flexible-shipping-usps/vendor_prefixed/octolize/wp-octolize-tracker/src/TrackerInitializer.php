...
class TrackerInitializer implements HookableCollection
{
     ...
     */
    public static function create_from_plugin_info(\FlexibleShippingUspsVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
