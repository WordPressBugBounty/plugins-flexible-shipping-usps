 ...
 */
class OnboardingTrackerData implements \FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIORITY = 1000;
    /**
     * @var string
     ...
     */
    public function __construct(string $append_data_to, \FlexibleShippingUspsVendor\Octolize\Onboarding\OnboardingOption $onboarding_option, $append_as = 'octolize_onboarding')
    {
