 ...
 * .
 */
class PageViewTracker implements \FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    use AdminPage;
    /**
     * @var ViewPageTracker
    ...
    public function view_tracking() : void
    {
        ...
        if (isset($_GET[\FlexibleShippingUspsVendor\Octolize\ShippingExtensions\PluginLinks::PLUGIN_LINKS_PAGE])) {
