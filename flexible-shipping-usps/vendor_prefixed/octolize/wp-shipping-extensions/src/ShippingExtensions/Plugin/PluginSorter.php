...
class PluginSorter
{
    ...
    public function compare(\FlexibleShippingUspsVendor\Octolize\ShippingExtensions\Plugin\Plugin $a, \FlexibleShippingUspsVendor\Octolize\ShippingExtensions\Plugin\Plugin $b) : int
    {
        return $this->get_plugin_priority($a) <=> $this->get_plugin_priority($b);
    }
    private function get_plugin_priority(\FlexibleShippingUspsVendor\Octolize\ShippingExtensions\Plugin\Plugin $plugin)
    {
        $priority = 0;
