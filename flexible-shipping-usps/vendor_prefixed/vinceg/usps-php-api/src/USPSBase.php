...
abstract class USPSBase
{
     ...
     */
    protected $apiCodes = ['RateV2' => 'RateV2Request', 'RateV4' => 'RateV4Request', 'IntlRateV2' => 'IntlRateV2Request', 'Verify' => 'AddressValidateRequest', 'ZipCodeLookup' => 'ZipCodeLookupRequest', 'CityStateLookup' => 'CityStateLookupRequest', 'TrackV2' => 'TrackFieldRequest', 'FirstClassMail' => 'FirstClassMailRequest', 'SDCGetLocations' => 'SDCGetLocationsRequest', 'ExpressMailLabel' => 'ExpressMailLabelRequest', 'PriorityMail' => 'PriorityMailRequest', 'OpenDistributePriorityV2' => 'OpenDistributePriorityV2.0Request', 'OpenDistributePriorityV2Certify' => 'OpenDistributePriorityV2.0CertifyRequest', 'ExpressMailIntl' => 'ExpressMailIntlRequest', 'PriorityMailIntl' => 'PriorityMailIntlRequest', 'FirstClassMailIntl' => 'FirstClassMailIntlRequest'];
    /**
     * Default options for curl.
     */
    public static $CURL_OPTS = [\CURLOPT_CONNECTTIMEOUT => 30, \CURLOPT_RETURNTRANSFER => \true, \CURLOPT_TIMEOUT => 60, \CURLOPT_FRESH_CONNECT => 1, \CURLOPT_PORT => 443, \CURLOPT_USERAGENT => 'usps-php', \CURLOPT_FOLLOWLOCATION => \true, \CURLOPT_RETURNTRANSFER => \true];
    /**
     * Constructor.
     *
