 ...
 */
class InfoBuilder extends \FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\FlexibleShippingUspsVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
