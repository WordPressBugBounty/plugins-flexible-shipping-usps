...
if (!\interface_exists('FlexibleShippingUspsVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FlexibleShippingUspsVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FlexibleShippingUspsVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FlexibleShippingUspsVendor\WPDesk_Translatable, \FlexibleShippingUspsVendor\WPDesk_Buildable, \FlexibleShippingUspsVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
