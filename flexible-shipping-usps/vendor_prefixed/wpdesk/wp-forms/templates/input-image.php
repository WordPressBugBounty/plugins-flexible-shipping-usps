...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-shipping-usps');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-shipping-usps');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-shipping-usps');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-shipping-usps');
?>"
				},
				library: {
					type: ['image']
