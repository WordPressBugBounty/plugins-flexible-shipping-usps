...
if (!\class_exists('FlexibleShippingUspsVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FlexibleShippingUspsVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-shipping-usps'), 'emergency' => \__('Emergency', 'flexible-shipping-usps'), 'alert' => \__('Alert', 'flexible-shipping-usps'), 'critical' => \__('Critical', 'flexible-shipping-usps'), 'error' => \__('Error', 'flexible-shipping-usps'), 'warning' => \__('Warning', 'flexible-shipping-usps'), 'notice' => \__('Notice', 'flexible-shipping-usps'), 'info' => \__('Info', 'flexible-shipping-usps'), 'debug' => \__('Debug', 'flexible-shipping-usps')];
        }
        /**
         * @param string $level
         * @param string $source
