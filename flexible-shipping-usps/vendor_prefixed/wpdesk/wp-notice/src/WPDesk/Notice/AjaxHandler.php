...
namespace FlexibleShippingUspsVendor\WPDesk\Notice;

use FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \FlexibleShippingUspsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \FlexibleShippingUspsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
