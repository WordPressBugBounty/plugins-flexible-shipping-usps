...
namespace FlexibleShippingUspsVendor\WPDesk\View\Renderer;

use FlexibleShippingUspsVendor\WPDesk\View\Resolver\Resolver;
/**
 * Can render templates
 */
class SimplePhpRenderer implements \FlexibleShippingUspsVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\FlexibleShippingUspsVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
