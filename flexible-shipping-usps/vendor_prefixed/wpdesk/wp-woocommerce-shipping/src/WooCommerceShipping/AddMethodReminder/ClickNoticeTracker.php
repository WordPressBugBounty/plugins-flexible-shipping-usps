 ...
 */
class ClickNoticeTracker implements \FlexibleShippingUspsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    use TrackerOption;
    private $method_id;
    /**
    ...
    {
        $display_strategy = new \FlexibleShippingUspsVendor\WPDesk\ShowDecision\GetStrategy([['page' => 'wc-settings', 'tab' => 'shipping']]);
