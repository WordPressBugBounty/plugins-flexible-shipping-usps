...
\esc_html_e('Code', 'flexible-shipping-usps');
?></th>
				<th class="service_name"><?php 
\esc_html_e('Name', 'flexible-shipping-usps');
?></th>
				<th class="select">
					<label>
						<?php 
\esc_html_e('Enabled', 'flexible-shipping-usps');
?>
						<input id="<?php 
echo \esc_attr($params['field_key']);
...
\esc_html_e('Drag and drop the services to control their display order. Confirm by clicking Save changes button below.', 'flexible-shipping-usps');
?></span></th>
			</tr>
			</tfoot>
		</table>
