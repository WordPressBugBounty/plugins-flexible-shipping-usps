...
namespace FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\Standard;
...
use FlexibleShippingUspsVendor\WPDesk\Persistence\Adapter\ArrayContainer;
use FlexibleShippingUspsVendor\WPDesk\Persistence\Adapter\WooCommerce\WooCommerceSessionContainer;
use FlexibleShippingUspsVendor\WPDesk\Tracker\Shop;
use FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\Cache\CachedRating;
...
use FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasRateCache;
 ...
 */
class StandardServiceRateMethod implements \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\RateMethod
{
    /** @var CanRate */
     ...
     */
    public function __construct(\FlexibleShippingUspsVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanRate $service)
    {
    ...
    public function handle_rates(\WC_Shipping_Method $method, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\ErrorLogCatcher $logger, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $metadata_builder, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingBuilder $shipment_builder)
    {
        try {
            ...
            if ($rates_count === \count($method->rates)) {
                $logger->info(\__('No rates added from standard service rates!', 'flexible-shipping-usps'));
            }
        } catch (\Exception $e) {
     ...
     */
    private function add_rates(\FlexibleShippingUspsVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanRate $service, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingMethod $method, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $meta_data_builder, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingBuilder $shipping_builder)
    {
     ...
     * @param WooCommerceShippingMetaDataBuilder $meta_data_builder Meta data builder.
     */
    private function add_rates_from_response(\WC_Shipping_Method $method, \FlexibleShippingUspsVendor\WPDesk\AbstractShipping\Shipment\Shipment $shipment, \FlexibleShippingUspsVendor\WPDesk\AbstractShipping\Rate\ShipmentRating $shipment_ratings, \FlexibleShippingUspsVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $meta_data_builder)
    {
