...
trait DeactivationContent
{
    ...
    private \FlexibleShippingUspsVendor\WPDesk\Tracker\Deactivation\ReasonsFactory $reasons_factory;
    /**
    ...
    public function getContent() : string
    {
        ...
        $ajax_action = \FlexibleShippingUspsVendor\WPDesk\Tracker\Deactivation\AjaxDeactivationDataHandler::AJAX_ACTION . $this->plugin_data->getPluginSlug();
