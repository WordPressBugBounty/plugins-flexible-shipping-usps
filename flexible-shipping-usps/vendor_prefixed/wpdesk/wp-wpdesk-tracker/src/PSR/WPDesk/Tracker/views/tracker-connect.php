...
?><br/>
			<?php 
\esc_html_e('Please help us improve our plugins! If you opt-in, we will collect some non-sensitive data and usage information anonymously. If you skip this, that\'s okay! All plugins will work just fine.', 'flexible-shipping-usps');
?>
		</p>
	</div>
...
\esc_html_e('Allow & Continue &rarr;', 'flexible-shipping-usps');
?></a>
		<a href="<?php 
echo \esc_url($skip_url);
?>" class="button button-secondary"><?php 
\esc_html_e('Skip', 'flexible-shipping-usps');
?></a>
		<div class="clear"></div>
	</div>
...
\esc_html_e('What permissions are being granted?', 'flexible-shipping-usps');
?></a>
		...
		<div class="permissions-details">
		    <ul>
		    	<li id="permission-site" class="permission site">
		    		...
		    		<div>
		    			<span><?php 
\esc_html_e('Your Site Overview', 'flexible-shipping-usps');
?></span>
		    			<p><?php 
\esc_html_e('WP version, PHP info', 'flexible-shipping-usps');
?></p>
		    		</div>
		    	</li>
...
?></span>
		    			<p><?php 
\printf(\esc_html__('Current settings and usage information of %1$s plugins', 'flexible-shipping-usps'), $shop_name);
?></p>
		    		</div>
		    	</li>
		    	<li id="permission-store" class="permission store">
		    		...
		    		<div>
		    			<span><?php 
\esc_html_e('Your Store Overview', 'flexible-shipping-usps');
?></span>
		    			<p><?php 
\esc_html_e('Anonymized and non-sensitive store usage information', 'flexible-shipping-usps');
?></p>
		    		</div>
		    	</li>
		    </ul>
