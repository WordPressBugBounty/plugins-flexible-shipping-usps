...
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\FlexibleShippingUspsVendor\WPDesk_Tracker::class, 'schedule']);
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \FlexibleShippingUspsVendor\WPDesk_Tracker_Factory_Prefixed($this->logger);
