...
if (empty($notice_content)) {
    ...
    ?><br/>
			<?php 
    echo \wp_kses_post(\__('We need your help to improve <strong>WP Desk plugins</strong>, so they are more useful for you and the rest of <strong>30,000+ users</strong>. By collecting data on how you use our plugins, you will help us a lot. We will not collect any sensitive data, so you can feel safe.', 'flexible-shipping-usps'));
    ?>
			<a href="<?php 
...
\esc_html_e('Enable usage tracking', 'flexible-shipping-usps');
?></button>
	</p>
</div>
<?php 
